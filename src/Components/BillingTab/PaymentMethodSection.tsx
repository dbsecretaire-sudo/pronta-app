...
const CardBrandIcon = ({ brand }: { brand?: string }) => {
  ...
  return Icon ? <Icon className="h-6 w-auto" /> : null;
};

const BankDetails = () => (
  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
    <h4 className="font-medium text-gray-900 mb-2">Nos coordonnées bancaires</h4>
    <p className="text-sm text-gray-600 mb-1"><strong>Titulaire du compte:</strong> MADAME BAUWENS DELPHINE</p>
    <p className="text-sm text-gray-600 mb-1"><strong>Banque:</strong> CR CORSE - Agence de CORTE</p>
    <p className="text-sm text-gray-600 mb-1"><strong>IBAN:</strong> FR76 1200 6000 2082 1095 4120 262</p>
    <p className="text-sm text-gray-600 mb-1"><strong>BIC:</strong> AGRIFRPP820</p>
    <p className="text-sm text-gray-600 mb-1"><strong>Adresse:</strong> VILLAGE, 20272 PIANELLO</p>
    <p className="text-sm text-gray-600 mb-1"><strong>Téléphone:</strong> 04 95 45 04 80</p>
    <p className="text-sm text-gray-600 mb-3"><strong>Domiciliation:</strong> Code établissement 12006 | Code guichet 00020 | Numéro de compte 82109541202 | Clé RIB 62</p>
    <p className="text-xs text-gray-500 italic">Ne communiquez ces informations qu'à des organismes de confiance pour éviter tout risque de fraude.</p>
  </div>
);
      ...
      {isEditing ? (
        <div className="space-y-3 p-4 bg-white rounded-lg shadow-sm mb-4">
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            {formData.type === 'bank_transfer' && <BankDetails />}
        ...
        <div className="bg-gray-50 p-3 rounded-lg border border-gray-200 mt-2">
          {paymentMethod ? (
            <>
              ...
              {paymentMethod.type === 'bank_transfer' && <BankDetails />}
            </>
          ) : (
